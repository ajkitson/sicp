...
;
; Of course, the definition of p isn't valid so this doesn't mean that applicative-order interpreters are bad,
; just that they don't do well with invalid code (p, in this case)