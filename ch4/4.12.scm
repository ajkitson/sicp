...
; and redefine the three procedure in terms of these abstractions.
; =====
; Cool! Wasn't super happy with how these were written. We've got a couple
; abstractions: finding a binding and updating a binding. We already have
; adding a binding to a frame.
;
; lookup-variable-value is "find-binding" + "return binding value"
; set-variable-value! is "find-binding" + "update binding value"
; define-variable! is "find-binding" + ("update binding value" OR "add binding")
